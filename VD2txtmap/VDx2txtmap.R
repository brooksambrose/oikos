#' Converts Voice Dream Reader annotation data into a visual outline of text highlights.
#' @param VDx Directory where Voice Dream Reader "Export Highlights" Action was saved.
#' @param VDtxt Directory where Voice Dream Reader "Export All Text" Action was saved.
#' @param txtmap Directory to save txtmap PDF files.
#' @param citekeys Character vector of citekeys to compile. Use "menu" to see all options
VDx2txtmap.f<-function(
    VDx='VDx'
    ,VDtxt='VDtxt'
    ,txtmap='txtmap'
    ,citekeys='menu'
